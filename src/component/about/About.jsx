...
const About = () => {
  return (
    ...
    <div className="row">
      <div className="col-lg">
        <img className="img-fluid" style={{ maxWidth: "100%", height: "auto", maxWidth: "612px", maxHeight: "408px" }} src={ab1} alt="" />
      </div>
      <div className="about-body col-lg d-flex  flex-column justify-content-center align-items-center">
        <div className="row">
          <div className="col">
            <div>
              <h3 className='about-title fs-2'>ABOUT US</h3>
        ...
        <div className="row justify-content-center"> 
          <div className="col about-text text-start"> 
            <img src={ab3} className="my-3" style={{ width: '40px', height: "auto" }} alt="" />
            <h4 className="">ENGAGEMENT</h4>
            <p>We are engagement specialists, who have led projects at all levels of the IAP2 spectrum. READ MORE</p>
          </div>
          <div className="col about-text text-start"> 
            <img src={ab2} className="my-3" style={{ width: "43px", height: "auto" }} alt="" />
            <h4>Communications</h4>
            <p>We are award-winning leaders in communications and campaign management. READ MORE</p>
          </div>
        </div>
