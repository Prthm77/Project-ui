      ...
      <div className="service-asset-2">
        ...
        <div className="service-container">
          <div className="service-body">
            ...
            <div className="row justify-content-center align-items-center">
              <div className="service-box  col-md-6 ">
                <h3 className="service-text text-end my-4">ENGAGEMENT</h3>
                <p className="service-sub-text text-end">
        ...
        <div className="service-container">
          <div className="service-body" style={{ height: "251px" }}>
            <div className="row justify-content-center align-items-center">
              <div className="service-box col-md-6 col-12">
                <img
                  className="img-fluid"
              ...
              <div className="service-box  col-md-6 col-12">
                <h3 className="service-text service-text text-start my-4">Communications</h3>
                <p className="service-sub-text text-start px-4">
          ...
          <div className="service-body">
            <div className="row justify-content-center align-items-center">
              ...
              <div className="service-box  col-md-6">
                ...
                <p className="service-sub-text text-start">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Faucibus quam quis egestas orci. Scelerisque eu, vitae sapien,
                  pellentesque et. Sit ac fames facilisis nibh faucibus.
                </p>
